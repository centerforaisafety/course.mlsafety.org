...
#### Adversarial Defense
- [Adversarial Machine Learning Applied to Intrusion and Malware Scenarios: A Systematic Review](https://ieeexplore.ieee.org/abstract/document/9001114)

#### Network Security and Monitoring
- [A hybrid machine learning approach to network anomaly detection](https://www.sciencedirect.com/science/article/abs/pii/S0020025507001648)

- [The Analysis of Firewall Policy Through Machine Learning and Data Mining](https://link.springer.com/article/10.1007/s11277-017-4330-0)

#### Endpoints and application security
- [Detecting and Characterizing Lateral Phishing at Scale](https://www.usenix.org/system/files/sec19-ho.pdf)

- [A Survey on Machine-Learning Based Security Design for Cyber-Physical Systems](https://www.mdpi.com/2076-3417/11/12/5458)
...
You Get What You Measure (AI aggressively pursues the wrong objective)
Power-seeking and Treacherous Turn (Deceptive Alignment; wat do?)
Persuasive AI
Value Lock-in (possibility of an ongoing moral catastrophe)
Weaponization, Scientific Hazards, and War (link to Nature hazard)
Multiple AIs Coordination Collusion

AI aggressively pursues the wrong objective, someone maliciously aligns AI, AI is used for (bio)weapons research, superintelligence becomes weaponized, an AI becomes has more power than other agents combined, AIs collude to overpower AI watchdog monitor, AI preserving itself by hacking computers and proliferating backups of itself, deceptive alignment, value lock-in, AI spurring sudden war (flash war a la flash crash), AI being extremely persuasive and manipulating the public, AI suddenly changing behavior when it gets the upper hand, world accelerates so to keep up we voluntarily cede control, and so on

Long-Term Risk Analysis
Dan needs to contemplate
Review
...
## Keeping up-to-date
- [reddit](https://newsletter.mlsafety.org)
